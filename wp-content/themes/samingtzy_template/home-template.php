            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4 img-container">
                  <div class="img-box">
                    <img src="<?php echo get_template_directory_uri().'/assets' ?>/images/slider-img.png" alt="">
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="experience_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <div class="img-box">
            <img src="<?php echo get_template_directory_uri().'/assets' ?>/images/experience-img.jpg" alt="">
          </div>
        </div>
        <div class="col-md-7">
          <div class="detail-box">
        ...
        <div class="row">
            ...
            <div class="detail-box">
              ...
              <div class="tab_container">
                <div class="t-link-box" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  <div class="img-box">
                    <img src="<?php echo get_template_directory_uri().'/assets' ?>/images/f1.png" alt="">
                  </div>
                  <div class="detail-box">
                    <h5>
                      $250 Million
                ...
                <div class="t-link-box collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                  <div class="img-box">
                    <img src="<?php echo get_template_directory_uri().'/assets' ?>/images/f2.png" alt="">
                  </div>
                  <div class="detail-box">
                    <h5>
                      2 Million
                ...
                <div class="t-link-box collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                  <div class="img-box">
                    <img src="<?php echo get_template_directory_uri().'/assets' ?>/images/f3.png" alt="">
                  </div>
                  <div class="detail-box">
                    <h5>
                      700,000
                ...
                <div class="t-link-box collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                  <div class="img-box">
                    <img src="<?php echo get_template_directory_uri().'/assets' ?>/images/f4.png" alt="">
                  </div>
                  <div class="detail-box">
                    <h5>
                      98%
          ...
          <div class="col-md-6">
            <div class="collapse show" id="collapseOne" aria-labelledby="headingOne" data-parent="#accordion">
              <div class="img-box">
                <img src="<?php echo get_template_directory_uri().'/assets' ?>/images/freelance-img.jpg" alt="">
              </div>
            </div>
